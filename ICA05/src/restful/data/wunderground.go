...
func GetWunderground(city string, country string) *Wunderground {
	api := GetAPI().WeatherW
	url := "http://api.wunderground.com/api/" + api + "/conditions/q/" + country + "/" + city + ".json"
	weather := new(Wunderground)
	GetJSON(url, weather)
	return weather
}

// Autogenerated struct from https://mholt.github.io/json-to-go/
